...
class QuizActivity : AppCompatActivity() {
    ...
    private fun startQuiz() {
        ...
        binding.radioGroup.setOnCheckedChangeListener { _, i ->
            when (i) {
                R.id.radio_button1 -> {
                    binding.radioButton1.background = ContextCompat.getDrawable(applicationContext, R.drawable.when_answer_selected)
                    binding.radioButton2.background = ContextCompat.getDrawable(applicationContext, R.drawable.default_option_bg)
                    binding.radioButton3.background = ContextCompat.getDrawable(applicationContext, R.drawable.default_option_bg)
                    binding.radioButton4.background = ContextCompat.getDrawable(applicationContext, R.drawable.default_option_bg)
                }
                R.id.radio_button2 -> {
                    binding.radioButton1.background = ContextCompat.getDrawable(applicationContext, R.drawable.default_option_bg)
                    binding.radioButton2.background = ContextCompat.getDrawable(applicationContext, R.drawable.when_answer_selected)
                    binding.radioButton3.background = ContextCompat.getDrawable(applicationContext, R.drawable.default_option_bg)
                    binding.radioButton4.background = ContextCompat.getDrawable(applicationContext, R.drawable.default_option_bg)
                }
                R.id.radio_button3 -> {
                    binding.radioButton1.background = ContextCompat.getDrawable(applicationContext, R.drawable.default_option_bg)
                    binding.radioButton2.background = ContextCompat.getDrawable(applicationContext, R.drawable.default_option_bg)
                    binding.radioButton3.background = ContextCompat.getDrawable(applicationContext, R.drawable.when_answer_selected)
                    binding.radioButton4.background = ContextCompat.getDrawable(applicationContext, R.drawable.default_option_bg)
                }
                R.id.radio_button4 -> {
                    binding.radioButton1.background = ContextCompat.getDrawable(applicationContext, R.drawable.default_option_bg)
                    binding.radioButton2.background = ContextCompat.getDrawable(applicationContext, R.drawable.default_option_bg)
                    binding.radioButton3.background = ContextCompat.getDrawable(applicationContext, R.drawable.default_option_bg)
                    binding.radioButton4.background = ContextCompat.getDrawable(applicationContext, R.drawable.when_answer_selected)
                }
            }
        }
    ...
    private fun checkSolution(answerNr: Int, rbSelected: RadioButton) {
        when (currentQ.answer) {
            1 -> if (currentQ.answer === answerNr) {
                /** radioButton1 */
                binding.radioButton1.background = ContextCompat.getDrawable(applicationContext, R.drawable.when_answer_correct)
            ...
            2 -> if (currentQ.answer === answerNr) {
                /** radioButton2 */
                binding.radioButton2.background = ContextCompat.getDrawable(applicationContext, R.drawable.when_answer_correct)
            ...
            3 -> if (currentQ.answer === answerNr) {
                /** radioButton3 */
                binding.radioButton3.background = ContextCompat.getDrawable(applicationContext, R.drawable.when_answer_correct)
            ...
            4 -> if (currentQ.answer === answerNr) {
                /** radioButton4 */
                binding.radioButton4.background = ContextCompat.getDrawable(applicationContext, R.drawable.when_answer_correct)
    ...
    private fun changeToIncorrectColor(rbSelected: RadioButton) {
        rbSelected.background = ContextCompat.getDrawable(applicationContext, R.drawable.when_answer_wrong)
