...
import com.example.englanguagefinal.databinding.FragmentQuizOffBinding
import com.example.englanguagefinal.extensions.toast
import com.example.englanguagefinal.model.exam.Question
import java.util.*

class QuizOffFragment : Fragment() {
    private lateinit var binding: FragmentQuizOffBinding
    ...
    private lateinit var wrongOfflineDialog: WrongOfflineDialog
    private lateinit var timerOfflineDialog: TimerOfflineDialog
    ...
    private var outOf: Boolean = true

    override fun onCreateView(
        inflater: LayoutInflater, container: ViewGroup?,
        savedInstanceState: Bundle?
    ): View {
        binding = FragmentQuizOffBinding.inflate(inflater, container, false)
        return binding.root
    }
    ...
    override fun onViewCreated(view: View, savedInstanceState: Bundle?) {
        ...
        wrongOfflineDialog = WrongOfflineDialog(requireActivity(), findNavController())
        timerOfflineDialog = TimerOfflineDialog(requireActivity(), findNavController())

        VocabularyDatabase.getInstance(requireActivity()).questionDao().getAllQuestions()
            .observe(requireActivity()) { questions ->
            ...
            when (i) {
                R.id.radio_button1 -> {
                    ...
                    binding.radioButton2.background =
                        ContextCompat.getDrawable(requireActivity(), R.drawable.default_option_bg)
        ...
        binding.btnConfirm.setOnClickListener {
            if (!answerd) {
                if (binding.radioButton1.isChecked || binding.radioButton2.isChecked || binding.radioButton3.isChecked || binding.radioButton4.isChecked) {
                    ...
                    requireActivity().toast("Please select answer!")
                }
            }
        }
    ...
    private fun quizOperation() {
        ...
        val rbSelected: RadioButton = requireActivity().findViewById(binding.radioGroup.checkedRadioButtonId)
    ...
    private fun checkSolution(answerNr: Int, rbSelected: RadioButton) {
        when (currentQ.answer) {
            1 -> if (currentQ.answer === answerNr) {
                /** radioButton1 */
                binding.radioButton1.background =
                    ContextCompat.getDrawable(requireActivity(), R.drawable.when_answer_correct)
                binding.radioButton1.setTextColor(
                ...
                wrongOfflineDialog.wrongDialog(correctAnswer)
            ...
            2 -> if (currentQ.answer === answerNr) {
                ...
                binding.radioButton2.background =
                    ContextCompat.getDrawable(requireActivity(), R.drawable.when_answer_correct)
                binding.radioButton2.setTextColor(
                    ContextCompat.getColor(
                        requireActivity(),
                        R.color.white
                    )
            ...
            3 -> if (currentQ.answer === answerNr) {
                ...
                binding.radioButton3.background =
                    ContextCompat.getDrawable(requireActivity(), R.drawable.when_answer_correct)
                binding.radioButton3.setTextColor(
                    ContextCompat.getColor(
                        requireActivity(),
                        R.color.white
                    )
            ...
            4 -> if (currentQ.answer === answerNr) {
                ...
                binding.radioButton4.background =
                    ContextCompat.getDrawable(requireActivity(), R.drawable.when_answer_correct)
                binding.radioButton4.setTextColor(
                    ContextCompat.getColor(
                        requireActivity(),
                        R.color.white
                    )
    ...
    private fun changeToIncorrectColor(rbSelected: RadioButton) {
        rbSelected.background =
            ContextCompat.getDrawable(requireActivity(), R.drawable.when_answer_wrong)
        rbSelected.setTextColor(ContextCompat.getColor(requireActivity(), R.color.white));
    }
    ...
    private fun setQuestions() {
        ...
        binding.radioButton1.setTextColor(ContextCompat.getColor(requireActivity(), R.color.gold));
        binding.radioButton2.setTextColor(ContextCompat.getColor(requireActivity(), R.color.gold));
        binding.radioButton3.setTextColor(ContextCompat.getColor(requireActivity(), R.color.gold));
        binding.radioButton4.setTextColor(ContextCompat.getColor(requireActivity(), R.color.gold));
        ...
        if (questionCounter < questionTotalCount!! - 1) {
            ...
            binding.txtTotalQuestion.text = "Question: " + questionCounter + "/" + (questionTotalCount!! - 1)
...
//                binding.txtTimer.setTextColor(ContextCompat.getColor(requireActivity(), android.R.color.holo_red_dark))
//            } else {
//                binding.txtTimer.setTextColor(ContextCompat.getColor(requireActivity(), R.color.nearBlack))
//            }
//        }
//        if (timeLeftInMillis == 0L) {
//            if (outOf) {
//                Handler(Looper.getMainLooper()).postDelayed({
//                    timerOfflineDialog.timerDialog() }, 1000)
//            }
//        }
//    }
    ...
    private fun resultData() {
        val bundle = bundleOf(
            "UserScore" to score,
            "TotalQuizQuestions" to (questionTotalCount!! - 1),
            "CorrectQuestions" to correctAns,
            "WrongQuestions" to wrongAns
        )
        findNavController().navigate(R.id.action_quizOffFragment_to_resultOfflineFragment, bundle)
    }
